package com.zdnerthcet.techtrendzuserservice;
...
public class TestTechTrendzUserServiceApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.from(TechTrendzUserServiceApplication::main).with(TestTechTrendzUserServiceApplication.class).run(args);
    }
